...
REPOSITORY="https://github.com/CumulusNetworks/webscale-asymmetric"
REPONAME="webscale-asymmetric"
...
install_puppet(){
    ...
    sed -i 's/10.255.7.1/10.255.7.1 puppet /g'>> /etc/hosts
}
...
#sudo bash -c 'echo "certname = 10.255.7.1" >> /etc/puppetlabs/puppet/puppet.conf'
